...
const CopyCmd = () => {
    ...
    return (
        <motion.button
            ...
            className="hidden sm:inline-flex group relative items-center gap-2.5 px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl bg-muted/70 border border-border font-mono text-xs sm:text-sm cursor-pointer select-none transition-colors duration-200 hover:bg-muted hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 shrink-0"
